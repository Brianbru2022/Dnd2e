...
const LANGUAGE_POOLS:Record<RaceId,string[]>={human:["Common","Dwarven","Elven","Gnome","Goblin","Halfling","Orc"],dwarf:["Common","Dwarven","Gnome","Goblin","Kobold","Orc"],elf:["Common","Elven","Gnome","Goblin","Halfling","Orc"],gnome:["Common","Gnome","Dwarven","Goblin","Halfling","Kobold"],"half-elf":["Common","Elven","Dwarven","Gnome","Goblin","Halfling","Orc"],halfling:["Common","Halfling","Dwarven","Elven","Gnome","Goblin"]};
...
export default function FinalDetails(){
 ...
 const chosenRace:RaceId=race;
 const pool=LANGUAGE_POOLS[chosenRace];
